 ...
 */
void Variable2D::set_geometry(Geometry2D& g)
{
    geometry = &g;
 ...
 */
void Variable2D::check_geometry(Domain2DUniform* s)
{
    if (geometry == nullptr)
 ...
 */
void Variable2D::set_center_field(Domain2DUniform* s, field2& f)
{
    check_geometry(s);
...
void Variable2D::set_x_edge_field(Domain2DUniform* s, field2& f)
{
    check_geometry(s);
...
void Variable2D::set_y_edge_field(Domain2DUniform* s, field2& f)
{
    check_geometry(s);
...
void Variable2D::set_corner_field(Domain2DUniform* s, field2& f)
{
    check_geometry(s);
...
void Variable2D::set_boundary_type(Domain2DUniform*                                                s,
...
void Variable2D::set_boundary_value(Domain2DUniform* s, LocationType loc, double in_value)
{
    check_geometry(s);
